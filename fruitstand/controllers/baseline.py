...
from semtest.schemas import generate_baseline_schema
from semtest.factories import embeddings_factory, llm_factory
from semtest.utils import file_utils
from semtest.services.embeddings import EmbeddingsService
...
def start_filebased(
    ...
    output_file = _output_baseline(query_llm, query_model, embeddings_llm, embeddings_model, baseline_data, output_directory)
